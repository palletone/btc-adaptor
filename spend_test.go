...
//
//	//the return 'transactionhex' is used in next step
//	result, err := SignTransaction(params, NETID_TEST)
//	if err != nil {
//		fmt.Println(err.Error())
//	} else {
//		if result.Complete {
...
//	
//
//	resultLast, err := SignTransaction(paramsSigned, NETID_TEST)
//	if err != nil {
//		fmt.Println(err.Error())
//	} else {
...
//	//the return 'transactionhex' is used in next step
//	resultTransToMultsigAddr, err := SignTransaction(paramsTransToMultsigAddr, NETID_TEST)
