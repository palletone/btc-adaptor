...
func TestRawTransactionGen(t *testing.T) {
	...
	rawTransactionGenParams.Inputs = append(rawTransactionGenParams.Inputs, Input{txid1, uint32(vout1)})
	rawTransactionGenParams.Inputs = append(rawTransactionGenParams.Inputs, Input{txid2, uint32(vout2)})
	rawTransactionGenParams.Outputs = append(rawTransactionGenParams.Outputs, Output{address, amount})
...
func TestGetTransactionByHash(t *testing.T) {
	...
	var getTransactionParams GetTransactionByHashParams
